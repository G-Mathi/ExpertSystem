//
//  AnswerProgramaticalCVCell.swift
//  ExpertSystem
//
...
class AnswerProgramaticalCVCell: UICollectionViewCell {
    static let identifier = "AnswerProgramaticalCVCell"
...
extension AnswerProgramaticalCVCell {
